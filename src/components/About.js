    ...
    <div className="container-md py-16  text-center min-h-[80vh] ">
      ...
      <div className=" mx-auto bg-appTheme dark:bg-[#1E2836] py-4 px-6 rounded-b-2xl shadow-2xl space-y-4 md:text-base text-s text-center items-center dark:border dark:border-gray-700">
        ...
        <p className="dark:text-slate-400">
          <span className="text-btnTheme font-semibold dark:text-[#3758F9]">BiteBox</span> is a food
        ...
        <p className="dark:text-slate-400">
          <span className="text-btnTheme font-semibold dark:text-[#3758F9]">Tech Stack used :</span>{" "}
          React.js, parcel, Redux-toolkit, Jest(testing) & Tailwind CSS.
        </p>
        <p className="dark:text-slate-400">
          <p>
            <span className="text-btnTheme font-semibold dark:text-[#3758F9]">Key Features :</span>{" "}
          ...
          <p className="my-4 dark:text-slate-400"> 
            <span className="text-btnTheme font-semibold dark:text-[#3758F9]">Upcoming Features :</span>{" "}
