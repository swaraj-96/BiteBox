...
const Contact = () => {
  return (
    <div className="max-w-[768px] w-[90%] mx-auto py-16  min-h-[80vh] items-center">
      <div className="bg-white dark:bg-[#1E2836] py-8 rounded-br-2xl shadow-2xl px-8 text-base dark:border dark:border-gray-700">
        ...
        <div className="my-4">
          <h2 className="font-bold text-lg text-btnTheme dark:text-indigo-800">
            Contact Me
          </h2>
          <div className="flex mt-2 gap-2 items-center">
            <IoIosMail className="w-8 h-8 text-gray-700 dark:text-slate-400" />
            <p className="text-gray-500 text-base dark:text-slate-400">
              pswaraj96@gmail.com
            </p>
          </div>
